...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_address_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Person;
}  // namespace protobuf_address_2eproto
namespace tutorial {
...
::google::protobuf::internal::SCCInfo<1> scc_info_AddressBook =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsAddressBook}, {
      &protobuf_address_2eproto::scc_info_Person.base,}};
...
const Person& Person::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_address_2eproto::scc_info_Person.base);
