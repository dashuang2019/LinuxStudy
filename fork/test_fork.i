...
int executeCmd(const char *cmd, char* const input[]) {
  pid_t pid;
  char **env;
  extern char **environ;
  char filename[256] = {};
...
int AaFileTarGzipItemArray(char* archivePath, char** itemPathArray, unsigned int itemPathArraySize, char* relativeDirPath)
{
    if (itemPathArraySize > 0)
    {
        ...
        char* opt = (char*)"-czPf";
        char* optDir = (char*)"-C";
        char* input[] = {cmd, opt, archivePath, fileList, ((void *)0), ((void *)0), ((void *)0)};
        if (relativeDirPath != ((void *)0))
        {
            input[4] = optDir;
...
# 157 "test_fork.c"
    AaFileTarGzipItemArray(targetFileName, itemPathArray, itemPathArraySize, ((void *)0));
    return 1;
# 182 "test_fork.c"
}
